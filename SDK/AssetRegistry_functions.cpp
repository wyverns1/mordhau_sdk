...
// Function AssetRegistry.AssetRegistry.ScanPaths
// (Native, Public, HasOutParms, BlueprintCallable)
// Parameters:
// TArray<struct FString>         InPaths                        (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AssetRegistry.AssetRegistry.ScanPaths");

	UAssetRegistry_ScanPaths_Params params;
	params.InPaths = InPaths;
