...
void UBP_NavButton_C::Tick(struct FGeometry* MyGeometry, float* InDeltaTime)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_NavButton.BP_NavButton_C.Tick");

	UBP_NavButton_C_Tick_Params params;
