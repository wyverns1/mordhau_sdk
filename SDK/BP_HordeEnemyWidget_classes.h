...
class UBP_HordeEnemyWidget_C : public UMordhauUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BP_HordeEnemyWidget.BP_HordeEnemyWidget_C");
		return ptr;
	}
