...
public:
	...
	struct FString                                     OSSName;                                                  // 0x01F0(0x0010) (ZeroConstructor, Config)
	struct FString                                     HotfixManagerClassName;                                   // 0x0200(0x0010) (ZeroConstructor, Config)
	struct FString                                     DebugPrefix;                                              // 0x0210(0x0010) (ZeroConstructor, Config)
