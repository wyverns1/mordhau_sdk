...
// Enum AIModule.ECrowdSimulationState
enum class ECrowdSimulationState : uint8_t
{
	ECrowdSimulationState__Enabled = 0,
	ECrowdSimulationState__ObstacleOnly = 1,
	ECrowdSimulationState__Disabled = 2,
	ECrowdSimulationState__ECrowdSimulationState_MAX = 3
};


// Enum AIModule.ECrowdAvoidanceQuality
enum class ECrowdAvoidanceQuality : uint8_t
{
	ECrowdAvoidanceQuality__Low    = 0,
	ECrowdAvoidanceQuality__Medium = 1,
	ECrowdAvoidanceQuality__Good   = 2,
	ECrowdAvoidanceQuality__High   = 3,
	ECrowdAvoidanceQuality__ECrowdAvoidanceQuality_MAX = 4
};
