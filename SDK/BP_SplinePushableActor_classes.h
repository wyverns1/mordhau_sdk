...
public:
	...
	class UStaticMeshComponent*                        Area;                                                     // 0x04D8(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	class ABP_SplineActor_C*                           TargetSplineActor;                                        // 0x04E8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	struct FVector2D                                   SplineRange;                                              // 0x04F0(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     PreviousLocation;                                         // 0x04F8(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
