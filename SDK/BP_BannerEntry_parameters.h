...
struct UBP_BannerEntry_C_GetVisibility_1_Params
{
	ESlateVisibility                                   ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function BP_BannerEntry.BP_BannerEntry_C.Initialize
struct UBP_BannerEntry_C_Initialize_Params
{
...
struct UBP_BannerEntry_C_BndEvt__Button_0_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
};
...
struct UBP_BannerEntry_C_BndEvt__Button_0_K2Node_ComponentBoundEvent_1_OnButtonHoverEvent__DelegateSignature_Params
{
};

// Function BP_BannerEntry.BP_BannerEntry_C.ExecuteUbergraph_BP_BannerEntry
struct UBP_BannerEntry_C_ExecuteUbergraph_BP_BannerEntry_Params
{
