...
public:
	...
	struct FBodyInstance                               BodyInstance;                                             // 0x0138(0x0158) (Edit)
	...
	struct FFloatInterval                              ProceduralScale;                                          // 0x02D0(0x0008) (Edit)
...
public:
	...
	struct FVector                                     TouchingActorEntryPosition;                               // 0x0340(0x000C) (Transient, IsPlainOldData)
	struct FVector                                     FoliageVelocity;                                          // 0x034C(0x000C) (Transient, IsPlainOldData)
	struct FVector                                     FoliageForce;                                             // 0x0358(0x000C) (Transient, IsPlainOldData)
	struct FVector                                     FoliagePosition;                                          // 0x0364(0x000C) (Transient, IsPlainOldData)
