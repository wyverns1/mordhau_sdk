...
public:
	...
	struct FString                                     AdditionalCommandLineArguments;                           // 0x00A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, Config)
	struct FString                                     InheritedCommandLineArguments;                            // 0x00B0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, Transient)
